...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="navbar-collapse collapse justify-content-end" id="navbarSupportedContent">
    ...
    <ul class="nav navbar-nav ">
      ...
      <li class="nav-item"><a class="nav-link" href="index.php?page=add-item"><i class="fa fa-user-plus"></i> Add item</a></li>
...
<br>
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="index.php?page=add-item" class="list-group-item list-group-item-action"><i class="fa fa-user-plus"></i> Add item</a>
              <a href="index.php?page=all-items" class="list-group-item list-group-item-action"><i class="fa fa-users"></i> All Lost/Found items</a>
    ...
    <footer>
      ...
      <div class="container"><p> Made With love by Molly</p></div>
    </footer>
